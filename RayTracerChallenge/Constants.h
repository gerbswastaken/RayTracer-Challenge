...
namespace constants {
	inline constexpr int gWidth{ 640 };					//Width of the image generated
	inline constexpr int gHeight{ 360 };				//Height of the image generated
	...
	inline constexpr int gNumOfThreads{ 4 };			//Number of CPU cores to use (I found 3 to work the best on my PC, but it's a piece of shit, so mess around with it)
	inline constexpr int gReflectionRecursionLimit{ 5 };
