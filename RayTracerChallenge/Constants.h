...
namespace constants {
	inline constexpr int gWidth{ 256 };					//Width of the image generated
	inline constexpr int gHeight{ 144 };				//Height of the image generated
	...
	inline constexpr int gRefractionRecursionLimit{ 5 };
